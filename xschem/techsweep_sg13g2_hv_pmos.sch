...
F {}
E {}
T {Original implementation by (c) Boris Murmann} 810 -30 0 0 0.4 0.4 {}
N 470 -220 470 -170 {
lab=g}
N 470 -170 540 -170 {
lab=g}
...
C {devices/vsource.sym} 730 -170 0 0 {name=vd value=1.65}
...
compose vg_vec start= 0 stop=3.3  step=25m
compose vd_vec start= 0 stop=3.3  step=25m
  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vsb $var4
	run 
	wrdata techsweep_sg13_hv_pmos.txt noise1.all
	destroy all
	set appendwrite
